...
class EconomicCalendar:
    ...
    def _get_ppi_context_cached(self, force_refresh: bool = False) -> Optional[Dict[str, Any]]:
        ...
        try:
            from economic_data.cpi_data import get_ppi_context
            self._ppi_ctx_cache = get_ppi_context()
    ...
    def get_economic_calendar(self, force_refresh: bool = False) -> Dict:
        ...
        for event in unique_events:
            ...
            if ctx:
                ...
                elif ind == 'PPI' and ppi_ctx:
                    if ppi_ctx.get('forecast_value') is not None:
                        event['forecast_value'] = ppi_ctx['forecast_value']
                    elif ppi_ctx.get('forecast_hint'):
                        event['forecast_hint'] = ppi_ctx['forecast_hint']
